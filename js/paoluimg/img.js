...
function initFileInput(ctrlName, uploadUrl, allowedFileExtensions, maxFileSize, maxFileCount) {
    ...
    control.fileinput({
        ...
        if (response.success == true) {
            ...
            const htmlUrlFormat = '&lt;img src="' + imgUrl + '" alt="images" /&gt;' + "<br>";
            const bbcodeUrlFormat = "[img]" + imgUrl + "[/img]";
            const markdownUrlFormat = "![images](" + imgUrl + ")";

            $('#urlcode').append(imgUrl + '&nbsp;<button id="copy-btn" data-clipboard-text="' + imgUrl + '" class="btn btn-info btn-xs">一键复制</button>\n');
            $('#htmlcode').append(htmlUrlFormat);
            $('#bbcode').append(bbcodeUrlFormat + '&nbsp;<button id="copy-btn" data-clipboard-text="' + bbcodeUrlFormat + '" class="btn btn-info btn-xs">一键复制</button>\n');
            $('#markdown').append(markdownUrlFormat + '&nbsp;<button id="copy-btn" data-clipboard-text="' + markdownUrlFormat + '" class="btn btn-info btn-xs">一键复制</button>\n');
